...
export class RegionCheckController {
    ...
    checkRegion() {
        const supportedRegions = [
            'US', 'GB', 'ID', 'MY', 'TH', 'VN', 'PH', 'JP', 'SG', 
            'ES', 'IE', 'DE', 'FR', 'IT', 'BR', 'MX'
        ];

        const supportedCountries = [
            'United States', 'United Kingdom', 'Indonesia', 'Malaysia', 
            'Thailand', 'Vietnam', 'Philippines', 'Japan', 'Singapore',
            'Spain', 'Ireland', 'Germany', 'France', 'Italy', 'Brazil', 'Mexico'
        ];

  ...
  async CallApi<T>(
    ...
    try {
      ...
      if (!tiktok_access_token) {
        ...
        const tokenResponse = await this.authTikTokShopService.getAccessToken();
      ...
      const requestParams: Record<string, any> = {
        app_key: app_key || process.env.TIKTOK_SHOP_APP_KEY,
      ...
      // Generate signature
      const signature = generateSignature(requestParams, data, url);
      ...
      const config: AxiosRequestConfig = {
        ...
        headers: {
          ...
          'x-tts-access-token': tiktok_access_token, // TypeScript now knows this is a string
        },
        params: requestParams,
        data: method.toUpperCase() !== 'GET' ? data : undefined, // Only include data for non-GET requests
      };
